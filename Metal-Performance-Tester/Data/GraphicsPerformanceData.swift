...
// MARK: - Graphics Performance Result

/// Represents a graphics performance measurement result
struct GraphicsResult: Codable {
...
// MARK: - Graphics Performance Measurement Set

/// Represents a collection of graphics performance measurements with statistical analysis
struct GraphicsMeasurementSet: Codable {
    /// Individual graphics measurement results
    let individualResults: [GraphicsResult]
    ...
    /// Creates a new graphics measurement set from individual results
    init(individualResults: [GraphicsResult]) {
        guard !individualResults.isEmpty else {
            fatalError("Cannot create GraphicsMeasurementSet from empty results")
        }
    ...
    /// Creates a graphics measurement set with a single result
    init(singleResult: GraphicsResult) {
...
// MARK: - Graphics Test Result

/// Represents the result of a graphics performance test comparison
struct GraphicsTestResult: Codable {
    /// Current graphics performance measurement set
    let current: GraphicsMeasurementSet
    
    /// Baseline graphics performance measurement set
    let baseline: GraphicsMeasurementSet
    ...
    /// Creates a new graphics test result
    init(current: GraphicsMeasurementSet, baseline: GraphicsMeasurementSet, 
